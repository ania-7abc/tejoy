...
struct SendUpdateRequest : event_system::Event
{
    ...
    explicit SendUpdateRequest(nlohmann::json data, const std::string_view type, User recipient,
...
struct SendRawUpdateRequest : event_system::Event
{
    ...
    explicit SendRawUpdateRequest(nlohmann::json update, User recipient)
...
struct UpdateReceived : event_system::Event
{
    ...
    explicit UpdateReceived(nlohmann::json data, std::string type, User sender, const bool no_ack,
